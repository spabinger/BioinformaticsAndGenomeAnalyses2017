...
__(*)__ Realignment target creator
    ...
    java -Xmx2g -jar /BGA2017/GenomeAnalysisTK-3.7/GenomeAnalysisTK.jar -T RealignerTargetCreator \
    -R hg19.fasta -nt 2 -L target.bed \
    -I deduprg.bam -known ${KNOWN_INDELS_1} -known ${KNOWN_INDELS_2} -o target_intervals.list

__(*)__ Perform realignment
    
    java -Xmx2g -jar /BGA2017/GenomeAnalysisTK-3.7/GenomeAnalysisTK.jar -T IndelRealigner -R hg19.fasta -I deduprg.bam \
